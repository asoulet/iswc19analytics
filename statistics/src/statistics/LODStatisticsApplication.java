...
public class LODStatisticsApplication extends RobustaApplication {
	...
	public static void main(String[] args) {
		LODStatisticsApplication application = new LODStatisticsApplication();
		/*String[] open = {"-a","open"};
	...
	public RobustaConfiguration getRobustaConfiguration() {
		return new RobustaConfiguration("properties/robusta_statistics.properties");
	}
	...
	public ArrayList<MPMCMonitor> getMPMCMonitors() {
		...
		monitors.add(new StatisticsMonitor("properties/statistics.properties"));
		monitors.add(new HistoryMonitor("properties/statistics.properties"));
		return monitors;
	}
